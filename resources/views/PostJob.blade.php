...
<form  action="{{route('post.store')}}" method="POST">
  ...
  <div class="mb-3">
    ...
    <input type="text"  name="Comp_name" class="form-control" id="exampleInputPassword1">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Jobtitle</label>
    <input type="text"  name="Jobtitle"class="form-control" id="exampleInputPassword1">
  </div>
  <div class="mb-3">
